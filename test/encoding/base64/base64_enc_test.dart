  ...
  group('Group of Base64 Encoders', () {
    ...
    group('Base64 and Base64Url:', () {
      ...
      test('a single byte filled with zeroes', () {
        ...
        expect(base64enc(zeroedByte), 'AA==');
      ...
      test('two octets (2 character)', () {
        ...
        expect(base64enc(twoOctets), 'WHg=');
      ...
      test('three octets(3 character)', () {
        ...
        expect(base64enc(threeOctets), 'MTIz');
      ...
      test('four octets(4 character)', () {
        ...
        expect(base64enc(fourOctets), 'Ky0qLw==');
      ...
      test('five octets(5 character)', () {
        ...
        expect(base64enc(fiveOctets), 'JSYkJEA=');
      ...
      test('six octets (6 characteres)', () {
        ...
        expect(base64enc(sixOctets), 'PSNeXiM9');
      ...
      test('a sentence', () {
        ...
        expect(base64enc(sentence), encoded);
      ...
      test('Chinese', () {
        ...
        expect(base64enc(chinese), '4r+w5pu45Y+y');
      ...
      test('Greek', () {
        ...
        expect(base64enc(greek), encoded);
      ...
      test('The alphabet', () {
        ...
        for (int i = 0; i < alphabet.length; ++i) {
          ...
          expect(base64enc(bytes), dart.base64.encode(bytes));
          expect(base64Url(bytes), dart.base64Url.encode(bytes));
          // reversed bytes.
          final rBytes = BytesOf.utf8(reverse(word)).value;
          expect(base64enc(rBytes), dart.base64.encode(rBytes));
